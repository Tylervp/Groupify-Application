                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              ClipRRect(
                                ...
                                child: Image.asset(
                                  'assets/images/GroupifyLogoSmall.png',
                                  width: 100.0,
                                  height: 100.0,
                                  fit: BoxFit.cover,
                                ),
                                                                ...
                                                                child:
                                                                  ...
                                                                  decoration:
                                                                    ...
                                                                    hintText: FFLocalizations.of(
                                                                            context)
                                                                        .getText(
                                                                      'a29igl5p' /* Re-enter your password... */,
                                                                    ),
                                                                    hintStyle: FlutterFlowTheme.of(
                                                                            context)
                                                                        .bodySmall,
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return AlertDialog(
                                                                          title:
                                                                              const Text('WARNING'),
                                                                          content:
                                                                              const Text('Username or Email already in use'),
                                                                          actions: [
                                                                            TextButton(
                                                                  ...
                                                                  Padding(
                                                                    ...
                                                                    child: Text(
                                                                      FFLocalizations.of(
                                                                              context)
                                                                          .getText(
                                                                        't8to1ov5' /* Sign up with your Google accou... */,
                                                                      ),
                                                                      style: FlutterFlowTheme.of(
                                                                              context)
                                                                          .bodySmall,
